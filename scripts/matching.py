...
def _layered_product(*args):
    ...
    return functools.reduce(lambda A, B: np.einsum("ijl,jkl->ikl", A, B), args)
...
def _quadratic_assignment_faq_ot(
    ...
    for n_iter in range(1, maxiter + 1):
        ...
        grad_fp = (
            const_sum
            + _layered_product(A22, P[..., None], _transpose(B22))
            + _layered_product(_transpose(A22), P[..., None], B22)
        )
